  ...
  return (
    <div style={{ position: 'relative' }}>
      <button
        ...
        className={`w-10 h-10 rounded-full border flex items-center justify-center ${open ? 'bg-slate-900 border-slate-900 text-white' : 'bg-white border-slate-200 hover:bg-slate-50'}`}
      >
