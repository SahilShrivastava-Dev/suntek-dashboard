    ...
    <>
      ...
      {analytics && analytics.top5Suppliers !== undefined && (
        <div className="grid grid-cols-12 gap-5 mb-5">
          ...
          <div className="col-span-12 lg:col-span-5 card p-5" style={{ position: 'relative' }}>
      ...
      <div className="card2 p-6 mb-5" style={{ position: 'relative' }}>
        ...
        <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
          <div>
            <div className="text-base font-bold font-heading">{t('customers.customerLedger')}</div>
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-12 lg:col-span-6 card p-6" style={{ position: 'relative' }}>
          ...
          <div className="text-base font-bold font-heading">{t('customers.densityPreference')}</div>
