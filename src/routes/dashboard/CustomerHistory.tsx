    ...
    <>
      ...
      <div className="grid grid-cols-12 gap-5 mb-5">
        <div className="col-span-12 lg:col-span-3 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #bfdbfe', position: 'relative' }}>
          ...
          <div className="text-[11px] text-slate-500 mt-1">from BUSY Sundry Debtors</div>
        </div>
        <div className="col-span-12 lg:col-span-3 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #bfdbfe', position: 'relative' }}>
          ...
          <div className="text-[11px] text-slate-500 uppercase tracking-wider">Top customer · MTD · BUSY</div>
          <div className="text-[16px] font-extrabold mt-1 leading-tight text-blue-700">
            {topCustomer ? topCustomer.name : '…'}
          </div>
          <div className="text-[11px] text-slate-500 mt-1">
            {topCustomer ? fmtINR(topCustomer.mtdRevenue) + ' · ' + topCustomer.invoiceCount + ' invoices' : ''}
          </div>
        </div>
        <div className="col-span-12 lg:col-span-3 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #bfdbfe', position: 'relative' }}>
          ...
          <div className="text-[11px] text-slate-500 uppercase tracking-wider">Total debtors outstanding</div>
          <div className="text-[28px] font-extrabold mt-1 num text-blue-700">{kpis ? fmtINR(kpis.debtorsOutstanding) : '…'}</div>
          <div className="text-[11px] text-slate-500 mt-1">Dr balance in Sundry Debtors</div>
        </div>
        <div className="col-span-12 lg:col-span-3 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #bfdbfe', position: 'relative' }}>
          ...
          <div className="text-[11px] text-slate-500 uppercase tracking-wider">FY sales invoices</div>
          <div className="text-[28px] font-extrabold mt-1 num text-blue-700">{kpis ? kpis.salesInvoiceCount : '…'}</div>
          <div className="text-[11px] text-slate-500 mt-1">{kpis ? fmtINR(kpis.fyRevenue) + ' total' : ''}</div>
        </div>
      </div>
      ...
      {analytics && (
        <div className="grid grid-cols-12 gap-5 mb-5">
          ...
          <div className="col-span-6 lg:col-span-3 card p-5" style={{ position: 'relative' }}>
            ...
            <div className="text-[11px] text-slate-500 uppercase tracking-wider">Revenue per Customer · FY</div>
            <div className="text-[24px] font-extrabold mt-1 num text-slate-800">{fmtINR(analytics.revenuePerCustomer)}</div>
            <div className="text-[11px] text-slate-500 mt-1">across {analytics.uniqueCustomersFY} unique buyers</div>
          </div>
          ...
          <div className="col-span-6 lg:col-span-3 card p-5" style={{ position: 'relative' }}>
            ...
            <div className="text-[11px] text-slate-500 uppercase tracking-wider">Debtor Turnover Ratio</div>
            <div className="text-[24px] font-extrabold mt-1 num text-slate-800">{analytics.debtorTurnover}×</div>
            <div className="text-[11px] text-slate-500 mt-1">DSO {analytics.dso} days · target &lt;30 d</div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-6 card p-5" style={{ position: 'relative' }}>
            ...
            <div className="text-[11px] text-slate-500 uppercase tracking-wider mb-3">Top-5 Customer Revenue Concentration</div>
      ...
      {analytics && analytics.top5Suppliers !== undefined && (
        <div className="grid grid-cols-12 gap-5 mb-5">
          ...
          <div className="col-span-6 lg:col-span-3 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #BFDBFE', position: 'relative' }}>
            ...
            <div className="mt-2">
              <span style={{
                ...
                {analytics.invoiceFrequency >= 3 ? '✓ Sticky repeat buyers' : 'Moderate repeat rate'}
              </span>
            </div>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #BFDBFE', position: 'relative' }}>
            ...
            <div className="text-[11px] text-slate-500 uppercase tracking-wider mb-3">Top-5 Supplier Spend Concentration</div>
          ...
          <div className="col-span-12 lg:col-span-4 card p-5" style={{ background: 'var(--blue-soft)', border: '1px solid #BFDBFE', position: 'relative' }}>
            ...
            <div className="text-[11px] text-slate-500 uppercase tracking-wider mb-1">Monthly Purchase Trend · 6 m</div>
            <MiniBarChart
          ...
          <table className="dt">
            <thead>
              <tr>
                ...
                <th className="num">FY Invoices</th>
